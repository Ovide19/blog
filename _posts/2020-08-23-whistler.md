...
Let's first grab a sample data file from [the Worldwide Archive of Low-Frequency Data and Observation's website](http://waldo.world/), a.k.a. WALDO. Following one of WALDO's curator's advice, I will use data collected at the Palmer Antarctica Station in this example. Palmer Station is located on Anvers Island, on the tip of the Antarctic peninsula; it records broadband VLF data at 100kHz using two cross-loop magnetic field antennas:

![VLF antenna](/blog/assets/images/VLFatPalmer.JPG)


The corresponding time series are stored as one minute chunks: let's go ahead and download the file acquired on January 1, 2012, at 02:10AM, which unzips as a .mat file named PA120101021000_021.mat. 
